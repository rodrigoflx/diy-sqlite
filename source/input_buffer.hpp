...
public:
     ...
     * 
     * @param input_stream A reference to an input stream (e.g., std::cin, std::ifstream).
     */
     ...
     * 
     * @return auto A string representing the next line. Returns an empty string if EOF is reached.
     */
